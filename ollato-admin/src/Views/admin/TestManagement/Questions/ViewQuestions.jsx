...
import { getAllSubCategory, getSpecificQuestion } from '../../../../Actions/Admin/Test/Question'
                      ...
                      >
                        <div className='form-control d-flex align-items-center flex-column justify-content-center text-center'>
                          <div className='img-box'>
                            <img
                              src={'http://3.7.98.19:1340/' + mainData?.path}
                              alt=''
                            />
                          </div>
                        </div>
                          ...
                          <>
                            <div className='optionitembox'>
                              ...
                              >
                                <div className='form-control d-flex align-items-center flex-column justify-content-center text-center'>
                                  <div className='img-box'>
                                    <img src={'http://3.7.98.19:1340/' + data?.path} alt='' />
                                  </div>
                                </div>
                              </Form.Group>
                              }
