                      ...
                      <Form className='light-bg'>
                          ...
                          <div className="col-md-6">
                              <Form.Group className="form-group" controlId="formprofiletype">
                                ...
                                <Form.Control type="text" disabled placeholder="Enter Profile Type" />
                              </Form.Group>
                            </div>
                            <div className="col-md-6">
                              <Form.Group controlId='formFile' className='form-group resume-file-input' >
                                <Form.Label>File</Form.Label>
                                <Form.Control type='file' title='Upload Resume' disabled className='hidden-file' name='files' />
                            ...
                            <div className="addmoreaddbox d-flex align-items-start">
                                 <div className="option-item">
                                  ...
                                  <Form.Group className="form-group" controlId="formsubprofile">
                                    ...
                                    <Form.Control type="text" disabled placeholder="Enter Sub Profile" />
                                  </Form.Group>
                                  </div>
                                 </div>
                            </div>
