  ...
  const actionbutton = (row, cell) => {
    return (
      <div className='button-box'>
        <Link
          to={`/norms-management/test-time-norms/view-test-time-norms/${cell?.id}`}
        >
        ...
        <Link
          to={`/norms-management/test-time-norms/edit-test-time-norms/${cell?.id}`}
        >
    ...
    <>
      <div className='common-layout common-dashboard-wrapper'>
        ...
        <div className='main-content-box'>
          ...
          <TitleHeader
            name='Test Time Norms'
            title='Norms Management'
            rowArray={rowArray}
            location={location}
            url='add-new-test-time-norms'
          />
